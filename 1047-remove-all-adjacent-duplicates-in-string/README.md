...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/)
...
**My Solution:** [1047-Remove-All-Adjacent-Duplicates-In-String.cpp](./1047-Remove-All-Adjacent-Duplicates-In-String.cpp)
